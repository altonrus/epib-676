...
#n_psa_iters <- 1000 #Uncomment this for the final version
...
Construct a tornado diagram by varying each parameter in t_reward (to simplify, we won't include the transition probabilities in t_prob for this part). We will only do this for the adult cohort.
