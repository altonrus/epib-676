...
If `project_future` is true, it returns three outcomes for us to compare to calibration targers;
...
IMIS <- function(B=10, B.re=3000, number_k=100, D=0,t_cohort){
  B0 = B*10
  ...
  for (k in 1:number_k ){
    ...
    like_all = c(like_all, likelihood(X_k, t_cohort))		# Calculate the likelihoods
