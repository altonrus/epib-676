...
-   Temporary state for 1 cycle

-   A 'workaround' for the Markov property. If costs, outcomes, or transitions differ for beginning or end period of health condition, break it into tunnel states
:::
:::
...
-   Transition probabilities are probability of making the transition during a cycle

-   Available data may

    -   be a probability for a different cycle length (e.g., 2-year probability instead of 6 month)

    -   Be reported as a rate (e.g., 200 events per person-year)

-   Rates are instintaneous force of an event

-   Probability is the cumulative risk over a defined period
