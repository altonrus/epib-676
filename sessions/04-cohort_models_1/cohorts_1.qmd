...
rowSums(m_cost_by_cyclestate)
#Discounted costs by year
rowSums(m_cost_by_cyclestate)*disc_mults
#Net present costs starting in cycle 1
sum(rowSums(m_cost_by_cyclestate)*disc_mults)
```
...
-   Assignment 2 available; due Wednesday 9/16
