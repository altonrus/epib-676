...
## Model-based decision analysis as science + art

-   **Science:** developing and coding modeling methods correctly

-   **Art:** decide on analytic framework, relevant trade-offs, model structure, outcomes captured, parameter values/ranges/distributions, reporting (interpretation and contextualization)
...
-   Some countries still ban immigrants living with HIV
...
-   Many sources are used to inform the different parameter values under different interventions, with no head-to-head trial comparing all of the interventions **(Most common)**
...
-   **Tufts CEVR Cost Effectiveness Registry**
    ...
    -   Can search for prior work on topic

    -   Can also search for ICERS and utilities from other studies
...
-   Can borrow their methods (with citation)
...
Students doing applied decision analysis, should have
...
::: {.column width="35%"}
**Start simple and focus on what's important! A model should capture important tradeoffs, not not perfectly mirror reality**
:::
:::
