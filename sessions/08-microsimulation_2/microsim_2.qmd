...
[`lapply`](http://127.0.0.1:10415/help/library/base/help/lapply), [`simplify2array`](http://127.0.0.1:10415/help/library/base/help/simplify2array); [`tapply`](http://127.0.0.1:10415/help/library/base/help/tapply), and convenience functions [`sweep`](http://127.0.0.1:10415/help/library/base/help/sweep) and [`aggregate`](http://127.0.0.1:10415/help/library/base/help/aggregate).
...
-   First get your model running, then use profiler to decide how much to optimize
...
-   Office hours in conference room #1103 now
