...
```{r}
#| echo: true
#Sampling gender for 100 simulants (binomial)
p_female = 0.7
v_isFemale <- rbinom(n=100, size=1, p=p_female)
sum(v_isFemale)

#Sampling gender for 100 simulants (random number)
...
#Can plot cumulative distribution function
plot(cost_emp_dist)
```
...
-   Added [info for non-programming assignments](https://htmlpreview.github.io/?https://github.com/altonrus/epib-676/blob/main/syllabus/info_assignments_nonprogramming.html) in 'syllabus' folder
