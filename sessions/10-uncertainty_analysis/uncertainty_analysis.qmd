...
t_twoway$preferred <- ifelse(t_twoway$ICER > 50000, "Treat", "No treat")
head(t_twoway)
```
...
-   Intervention who's line is highest is the most likely to be cost-effectve for given WTP

-   Frontier is the intervention with the greatest expected NMB

    -   Optimal decision is to chose intervention on the frontier, not intervention with the greatest probability of being cost-effective
