...
-   Intervention who's line is highest is the most likely to be cost-effective for given WTP

-   Frontier is the intervention with the greatest expected NMB

    -   Optimal strategy is one that maximizes expected NMB, not necessarily the one with the greatest probability of being cost-effective (usually same for most WTPs though)
