...
Many smaller functions calling each other \> 1 massive function
...
-   Use when data use agreement / ethics prevents sharing data

-   Warning: objects other than data tables can include data (e.g., saving a 'random forest object' from ranger)
