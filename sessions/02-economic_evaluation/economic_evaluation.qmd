...
-   Hepatitis B screening strategies → % cases detected, incidence
...
-   **Patient-level** costs often right-skewed (a few high-cost patients)
    ...
    -   But, parameter of interest usually **average cost**, should be less skewed
...
-   Same discount rate used for costs & outcomes (contested in theory but near universal practice)
...
-   Typically largest non-health cost in societal perspective
...
-   For death-related productivity loss, we want "net productivity loss" with consumption subtracted out
...
-   $NMB_a \geq NMB_b \Leftrightarrow ICER_{\text{\{a vs. b\}}} \leq WTP$, both imply that $a$ is cost-effective compared to $b$
...
-   Payer for intervention may not realize cost savings
