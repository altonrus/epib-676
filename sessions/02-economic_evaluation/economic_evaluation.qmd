...
-   Differences in cost, side-effects of the intervention(s)

-   Differences in 'Downstream' health and costs

## Time horizon

-   Should capture all relevant differences in costs & health outcomes

-   Sometimes, short time horizon OK
...
-   Often right-skewed (a few high-cost patients)
...
-   Prefer getting money today vs. in the future?

-   Losing money in today vs. in the future?
...
-   In practice, same discount rate used for costs & outcomes (strongly contested in theory)

## Currency exchange

-   Suggested to use purchasing power parity (estimated cost of a basket of goods) rather than exchange rate
...
-   Suggested to use the annual average all-item consumer price index (CPI)
...
-   Typically largest cost "societal perspective only" cost
...
-   For death-related productivity loss, should tally "net productivity loss" by subtracting consumption
...
-   But most analysts don't, and methods to do so are not well-established
...
-   Cost-effectiveness of alternative vs. status quo depends on quadrant alternative falls into
:::
:::
...
-   Don't report negative ICER's exact value, instead say strategy '**dominated**' (Q4) or '**dominant**' (Q2)

-   If in Q3, reverse comparison when reporting ICER

    -   **Alternative in Q1**: Alternative costs \$32,000 per QALY gained compared to status quo

    -   **Alternative in Q3**: Status quo costs \$32,000 per QALY gained compared to alternative

## Comparing multiple interventions

With \>2 alternatives, conduct incremental analysis:

1.  Order by increasing effectiveness

2.  Remove dominated alternatives

3.  Calculate ICERs between non-dominated alternatives

Always calculate ICER relative to **next-least-effective, non-dominated** intervention
...
-   CAD\$50,000/QALY often cited by CADTH
...
-   ICER not ideal in some contexts because (1) negative ICERs ambiguous and (2) ratios don't behave well with small denominators

-   Calculate Net Monetary Benefit by assigning \$ value to health benefits using WTP:

$$
NMB_a = \bar{c}_a + \bar{e}_a\times WTP
$$

-   $NMB_a > NMB_b$ → $a$ is cost-effective compared to $b$ ($ICER_{\text{\{a vs. b\}}} \leq WTP$)

## Cost effective ≠ affordable

-   Often, costs are front-loaded
    -   Upfront costs high; savings take years to realize

```{=html}
<!-- -->
```
-   Party paying upfront cost may not benefit from cost offsets

-   **Example:** [Liu et. al. 2014](https://doi.org/10.7326/M14-0602) found:

    -   Treating HCV+ prisoners with Sofosbuvir costs \<US\$30,000 per QALY

    -   \$32 billion upfront cost to correctional system
...
-   Cost-effectiveness analyses measure costs and health outcomes

-   Cost-effectiveness determined with Incremental analysis, ICERs, and willingness-to-pay

-   Concepts covered in great detail in PPHS 528 next fall

## Logistics

-   Assignment 0 due next Wednesday 1/11
-   Complete reading before Wednesday's class
