...
-   Prob. of $A$ occurring [**conditioned o**]{.underline}**n** $B$ having occurred (probability $A$ [**given**]{.underline} $B$):
...
> No, shorter humans tend to know less vocabulary because they are often children. But height and vocabulary are likely independent **conditioned on** a person being \>19 years old
...
-   Describes belief (uncertainty) about an uncertain probability
...
-   Starts with a 'decision node' (the 'root node"); ends in 'leaf nodes ('terminal nodes')
...
-   Easy to combine with other modeling methods
...
-   Assignment 0 due 11:59pm tomorrow

-   Assignment 1 (cost-effectiveness, decision trees) due next Friday , September 15
