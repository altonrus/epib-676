...
The **beta distribution** models our belief/uncertainty about a probability $p$
...
::: {.column width="50%"}
-   Things we control are decisions

-   Random events are chances
:::
:::
...
-   Probabilities conditional on earlier events

-   Terminal node outcomes are specific to the path
:::
:::
...
**Decision**: offer a diet or exercise program?

**Chances**: will they need a stent?

**Outcome**: cost, QALYs lost related to receiving a stent
...
In a small trial of the "diet" programme, **12 out of 68** patients (17.6%) avoided having a procedure, and in a separate small trial of the "exercise" programme **18 out of 58** patients (31.0%) avoided the procedure (it is assumed that the baseline characteristics in the two trials were comparable). A stent leads to one year with a health state utility of **0.75**.
...
-   For each chance node from **right to left**, calculate the expected value of each outcome
...
-   Key probability building blocks:
    ...
    -   Beta distribution for uncertainty in probabilities
