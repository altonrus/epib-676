...
-   **Equity/fairness from health systems perspective**

-   Methods for incorporating equity in decision analyses

-   Distributional cost-effectiveness tutorial

## Health systems perspective on equity

-   Several dimensions of concern

    -   Health, wealth, race, sex, gender, age, (dis)ability, socioeconomic status, neighborhood...
...
-   Portfolio of services may be viewed as unfair if:
    ...
    -   Improves or worsen existing inequities in health outcomes
...
-   Objective: Maximize total health benefit achieved through limited funds
...
-   **Health-benefit criterion:** The priority of an intervention increases with the expected health benefit (and other relevant welfare benefits) from the intervention

-   **Resource criterion:** The priority of an intervention increases, the less resources it requires

-   **Health-loss criterion:** The priority of an intervention increases with the expected lifetime health loss of the beneficiary in the absence of such an intervention.
...
## Proportional shortfall (Dutch approach)
...
-   Assigning patient population to severity group challenging
    ...
    -   [Severity-adjusted probability cost-effective](https://doi.org/10.1007/s40273-019-00810-8) couuld help

-   Do we consider age?

    -   Individual patient age not considered, but average patient age often is

## Support of severity-adjusted thresholds mixed
...
**Pro:** no quantitative analysis

**Con:** less clear guidance for decision (& depends on available data)

## Equity constraint analysis

-   How much benefit is foregone is the most cost-effective option is ruled out on equity grounds?
...
**Con:** requires subgroup data that may not exist
...
**Con:** complex calculation, and agreeing on the criterion may be challenging
...
![](Cleary_equity_constraints.jpeg)
...
-   1a. estimate the baseline health distribution
-   1b. model changes due to interventions being compared, allowing for the distribution of opportunity costs from additional resource use
-   1c. adjust the resulting modeled health distributions for alternative social value judgments about fair and unfair sources of health variation.

## DCEA evaluation stage

-   2a. use the estimated distributions to quantify the change in total population health and unfair health inequality due to each intervention

-   2b. rank the interventions based on dominance criteria;

-   2c. analyze tradeoffs between improving population health and reducing unfair health inequality, allowing for alternative specifications of the social welfare function.
...
-   Subgroups defined by sex, neighborhood deprivation quintile, neighborhood ethnic diversity (% from Indian subcontinent)
...
-   Equity considerations must be considered at health system level and in individual decision problems

-   Comprehensive analysis of equity implications in model possible with right data and methods, but challenging

-   Many frameworks but no consensus on optimal equity-efficiency trade-off

## Logistics

-   Assignment 4 due tonight

-   Project proposal due Friday, February 24

-   Assignment 5 to be posted by next Monday, due Wednesday March 8
